package com.research.spring.config;
...
@ComponentScan({
		"com.research.spring.dao" ,
		"com.research.spring.service"
})
public class HibernateTestConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.research.spring.model" });
